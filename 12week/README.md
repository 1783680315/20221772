...
<img src="img/screenshot_1.png" width="800" alt="ArUco 标记检测">

*ArUco 标记成功被检测并标注 ID*

<img src="img/screenshot_2.png" width="800" alt="距离估算结果">

*基于像素宽度的距离估算结果*

<img src="img/screenshot_3.png" width="800" alt="摄像头识别过程">

*手机摄像头实时识别 ArUco 标记*

<img src="img/screenshot_4.png" width="800" alt="检测结果验证">
